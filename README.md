...
--> will add test cases not just for coverage but for each line of code to covered.
--> if the code is repeated will use fucntions to avoid duplications
--> will add comments for better readability.
